...
parser.add_argument('--exp', type=str,  default='Fvnet_withMask_TranNum_2_size5', help='model_name')
...
if __name__ == "__main__":
    ...
    net = FVNet(n_channels=1, n_classes=num_classes, tranNum=2, normalization='batchnorm', has_dropout=True)
    net = net.cuda()
