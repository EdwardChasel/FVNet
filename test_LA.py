...
import torch
import glob
from networks.FVNet import FVNet
...
# parser.add_argument('--root_path', type=str, default='E:/dataset/medical_data/Atrial/AtrialSeg_3d_npy_margin', help='Name of Experiment')
parser.add_argument('--model', type=str,  default='Fvnet_withMask_TranNum_1_size5', help='model_name')
...
# image_list = glob.glob(os.path.join(FLAGS.root_path, 'val', '*_lgemri.npy'))
# print(image_list)

def test_calculate_metric(epoch_num):
    net = FVNet(n_channels=1, n_classes=num_classes, tranNum=1, normalization='batchnorm', has_dropout=False).cuda()
